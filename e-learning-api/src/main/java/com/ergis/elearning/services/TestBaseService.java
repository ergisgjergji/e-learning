...
public class TestBaseService {
    ...
    public TestBase create(TestBase testBase, Long course_id, String username) {
        ...
        if(this.isTestValid(testBase)) {
            ...
            // Create Test based on TestBase for each student of the course
            Set<User> courseStudents = userService.findAllRegisteredStudents(course_id, username);
            for(User student: courseStudents) {
                testService.create(testBase, course, student);
            }
        }
